...
assert goose_filter(["Mallard", "Hook Bill", "African", "Crested", "Pilgrim", "Toulouse", "Blue Swedish"]) == [
    "Mallard", "Hook Bill", "Crested", "Blue Swedish"]
assert goose_filter(["Mallard", "Barbary", "Hook Bill", "Blue Swedish", "Crested"]) == ["Mallard", "Barbary",
                                                                                        "Hook Bill", "Blue Swedish",
                                                                                        "Crested"]
