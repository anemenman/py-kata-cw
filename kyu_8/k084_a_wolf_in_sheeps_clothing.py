...
def warn_the_sheep(queue):
    wolf_position = queue[::-1].index('wolf')
...
assert warn_the_sheep(['wolf']) == 'Pls go away and stop eating my sheep'
assert warn_the_sheep(['sheep', 'sheep', 'sheep', 'sheep', 'sheep', 'wolf', 'sheep',
                       'sheep']) == 'Oi! Sheep number 2! You are about to be eaten by a wolf!'
assert warn_the_sheep(['sheep', 'wolf', 'sheep', 'sheep', 'sheep', 'sheep',
                       'sheep']) == 'Oi! Sheep number 5! You are about to be eaten by a wolf!'
assert warn_the_sheep(['wolf', 'sheep', 'sheep', 'sheep', 'sheep', 'sheep',
                       'sheep']) == 'Oi! Sheep number 6! You are about to be eaten by a wolf!'
